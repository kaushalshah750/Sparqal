                ...
                {isSubmitted ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-sm text-dark/60 text-center">
                      <span className="text-primary">*</span> All fields required • We respect your privacy
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="lg:col-span-2">
              <div className="sticky top-8">
                ...
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-dark mb-4">What Happens Next?</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-semibold flex-shrink-0 mt-0.5">1</div>
                      <p className="text-sm text-dark/80">We'll review your project details and get back to you within 24 hours</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-semibold flex-shrink-0 mt-0.5">2</div>
                      <p className="text-sm text-dark/80">Schedule a free consultation call to discuss your vision</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-semibold flex-shrink-0 mt-0.5">3</div>
                      <p className="text-sm text-dark/80">Receive a custom proposal with timeline and investment details</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <h3 className="font-semibold text-dark mb-2">Free Consultation</h3>
              <p className="text-sm text-dark/70">No obligation discovery call to understand your needs</p>
            </div>
            <div>
              <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-dark/70">We respond to all inquiries within 24 hours</p>
            </div>
            <div>
              <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-dark/70">Serving businesses nationwide with personalized service</p>
            </div>
          </div>
        </div>
      </section>
