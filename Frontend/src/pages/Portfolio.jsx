...
const PortfolioPage = () => {
  ...
  const filterCategories = [
    { key: "all", label: "All Projects", count: portfolioProjects.length },
    {
      key: "web-design",
      label: "Web Design",
      count: portfolioProjects.filter((p) => p.category === "web-design")
        .length,
    },
    {
      key: "web-app",
      label: "Web Application",
      count: portfolioProjects.filter((p) => p.category === "web-app").length,
    },
    {
      key: "e-commerce",
      label: "E-commerce",
      count: portfolioProjects.filter((p) => p.category === "e-commerce")
        .length,
    },
    {
      key: "seo-optimization",
      label: "SEO & Performance",
      count: portfolioProjects.filter((p) => p.category === "seo-optimization")
        .length,
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="View Sparqal’s web development portfolio featuring high-performance websites, SaaS applications, and custom digital solutions delivered for clients across industries."
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                ...
                transform their digital presence. Each project represents our
                commitment to excellence, innovation, and measurable results.
              </p>
            </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tags.slice(0, 3).map((tag, index) => (
                        <span
                          key={index}
                          className="text-xs bg-light text-gray-700 px-2 py-1 rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              ...
              something amazing together. Every great project starts with a
              conversation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                onClick={() =>
                  openUrl("https://calendly.com/kaushalshah750/1-1-discussion")
                }
              >
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.technologies.map((tech, index) => (
                      <span
                        key={index}
                        className="bg-light text-gray-700 px-3 py-2 rounded-lg font-medium"
                      >
                        {tech}
                      </span>
                    ))}
