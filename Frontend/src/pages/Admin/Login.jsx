...
const SparqalLogin = () => {
  ...
  const [email, setEmail] = useState("kaushal@example.com");
  const [password, setPassword] = useState("Kaushal$#@#123");
            ...
            <div className="relative z-10 max-w-md">
              ...
              <div className="mb-8">
                ...
                <p className="text-xl text-white/80 leading-relaxed">
                  Access your dashboard and continue building stunning websites
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Deploy your websites worldwide instantly
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full max-w-md">
              ...
              <div className="lg:hidden mb-12 text-center">
                ...
                <p className="text-gray-600">
                  Welcome back to your digital success
                </p>
              </div>
